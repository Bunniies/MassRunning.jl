...
# for N_f=3 theory
hp  = HyperParams(; _F2=uwreal([1.7505,0.0089], "F2"), F3_val=0.5226, Lambda_val=341, Lambda_F3_cov=[[150.7862014579557, 0.0] [ 0.0, 0.00001830314004469306]])

# for N_f=4 theory
hp4 = HyperParams(; _F2=uwreal([1.,0.0], "tmp"), F3_val=0.5226, Lambda_val=341*0.874415, Lambda_F3_cov=[[150.7862014579557*0.874415^2, 0.0] [ 0.0, 0.00001830314004469306]])
...
mSFmuhad3 = uwreal([1623.3,9.25],"mSFmuhadNf3") # input: m_q[SF, mu=mu_had, N_f=3]  
